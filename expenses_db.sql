...
CREATE TABLE public.token (
                              ...
                              CONSTRAINT token_pk PRIMARY KEY (id_user),
...
ALTER TABLE public.token ADD CONSTRAINT user_fk FOREIGN KEY (id_user)
...
ALTER TABLE public.user_trip_association ADD CONSTRAINT user_fk FOREIGN KEY (id_user)
    REFERENCES public."user" (id) MATCH FULL
...
ALTER TABLE public.user_trip_association ADD CONSTRAINT trip_fk FOREIGN KEY (id_trip)
...
ALTER TABLE public.user_cost_association ADD CONSTRAINT user_fk FOREIGN KEY (id_user)
    REFERENCES public."user" (id) MATCH FULL
    ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE public.user_cost_association ADD CONSTRAINT cost_fk FOREIGN KEY (id_cost)
